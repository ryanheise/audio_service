...
class PlaybackState {
  ...
  PlaybackStateMessage _toMessage() =>
      ...
      identical(other, this) ||
          other.runtimeType == runtimeType &&
              ...
              listEquals(
                  ...
                  other.androidCompactActionIndices) &&
...
class MediaControl {
  ...
  MediaControlMessage _toMessage() =>
      MediaControlMessage(
...
class IsolatedAudioHandler extends CompositeAudioHandler {
  ...
  /// this isolate can.
  IsolatedAudioHandler(AudioHandler inner, {
...
mixin QueueHandler on BaseAudioHandler {
  ...
  Future<void> updateQueue(List<MediaItem> newQueue) async {
    queue.add(queue.nvalue!
      ..replaceRange(0, queue.nvalue!.length, newQueue));
  ...
  Future<void> updateMediaItem(MediaItem mediaItem) async {
    queue.add(queue.nvalue!
      ..[queue.nvalue!.indexOf(mediaItem)] = mediaItem);
...
class _HandlerCallbacks extends AudioHandlerCallbacks {
  ...
  Future<List<MediaItem>> _onLoadChildren(String parentMediaId,
      Map<String, dynamic>? options) async {
